...
data_train = Dataset(train_glob, mask_glob)
data_test = Dataset(test_glob, mask_glob)

from partialconvworker import *
worker = PartialConvWorker(checkpoint_path, learning_rate)
worker.Train(epoch, batch_size, data_train, data_test, log_interval)
